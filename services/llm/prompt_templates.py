...
TRADE_PROMPT = (
    "आप कौन सा काम-धंधा जानते हैं या सीखना चाहते हैं? जैसे सिलाई, बढ़ई, राजमिस्त्री, बिजली या कोई और काम?"
)
...
FALLBACK_REPROMPT = (
    "माफ़ कीजियेगा, हम आपकी बात साफ़ सुन नहीं पाए। कृपया एक बार फिर बताएँ।"
)
